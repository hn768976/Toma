 ...
 *
 * 4D matters here: a 2D field that loops perfectly needs its time axis to
 * travel a *circle*, and a circle needs two dimensions. Simplex rather than
 * value noise because in 4D a simplex has 5 corners against a hypercube's 16 —
 * it is the cheaper of the two at this dimensionality, and has no grid
 * artifacts to fight.
 */
export const NOISE_4D = /* glsl */ `
