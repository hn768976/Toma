...
export const VERSIONS: VersionConfig[] = [
  {
    ...
    glass: {
      ...
      specColor: [1, 1, 1], refract: 0.068, absorb: 0.44, fresnelStrength: 0.5,
      dispersion: 0.07, specStrength: 1.5, innerAmount: 0.16,
      innerDensity: 0.22, edgeDark: 0.5, specPower: 70, rimWidth: 0.55, opacity: 0.93, wobble: 0.16,
    },
    field: {
      motion: 'converge', count: 72, minRadius: 0.34, maxRadius: 1.0,
      spreadX: 3.4, spreadY: 2.2, spreadZ: 2.6, driftSpeed: 0.3, rotateSpeed: 0.12,
      farRatio: 0.3, nearRatio: 0.1, seed: 1011,
    },
    camera: { ...base.camera, fov: 40, frameHeight: 10 },
    grade: { ...base.grade, vignette: 0.06, saturation: 0.96, contrast: 1.08, farBlur: 2.6 },
  },
  {
    ...
    glass: {
      ...
      specColor: [1, 0.99, 0.9], refract: 0.044, absorb: 1.36, fresnelStrength: 0.34,
      specStrength: 1.0, innerAmount: 0.3, innerScale: 4.6, innerDensity: 0.4,
      edgeDark: 0.34, specPower: 48, rimWidth: 0.66, opacity: 0.93, wobble: 0.06,
    },
    field: {
      motion: 'macroHero', heroRadius: 2.55, count: 22, minRadius: 1.4, maxRadius: 3.0,
      spreadX: 7.5, spreadY: 5.0, spreadZ: 7.0, driftSpeed: 0.12, rotateSpeed: 0.05,
      farRatio: 0.55, nearRatio: 0.0, seed: 2022,
    },
  ...
  },
  {
    ...
    glass: {
      ...
      specColor: [1, 1, 1], refract: 0.044, absorb: 1.20, fresnelStrength: 0.36,
      specStrength: 1.05, innerAmount: 0.3, innerScale: 4.6, innerDensity: 0.4,
      edgeDark: 0.34, specPower: 48, rimWidth: 0.66, opacity: 0.93, wobble: 0.06,
    },
    field: {
      motion: 'macroHero', heroRadius: 2.55, count: 22, minRadius: 1.4, maxRadius: 3.0,
      spreadX: 7.5, spreadY: 5.0, spreadZ: 7.0, driftSpeed: 0.12, rotateSpeed: 0.05,
      farRatio: 0.55, nearRatio: 0.0, seed: 3033,
    },
    camera: { ...base.camera, fov: 34, frameHeight: 10, pushIn: 0.6 },
  ...
  },
  {
    ...
    glass: {
      ...
      specColor: [1, 1, 0.96], refract: 0.041, absorb: 1.25, fresnelStrength: 0.32,
      specStrength: 1.15, innerAmount: 0.34, innerScale: 5.4, innerDensity: 0.46,
      edgeDark: 0.36, specPower: 55, rimWidth: 0.62, opacity: 0.93, wobble: 0.05,
    },
    field: {
      motion: 'rise', count: 44, minRadius: 0.75, maxRadius: 1.85,
  ...
  },
  {
    ...
    glass: {
      ...
      specColor: [1, 0.98, 0.88], refract: 0.048, absorb: 1.60, fresnelStrength: 0.3,
      specStrength: 1.0, innerAmount: 0.3, innerScale: 5.0, innerDensity: 0.44,
      edgeDark: 0.46, specPower: 52, rimWidth: 0.6, opacity: 0.93, wobble: 0.07,
    },
    field: {
      motion: 'fill', count: 64, minRadius: 0.7, maxRadius: 1.7,
  ...
  },
  {
    ...
    glass: {
      ...
      specColor: [1, 1, 1], refract: 0.065, absorb: 1.28, fresnelStrength: 0.4,
      dispersion: 0.06, specStrength: 1.35, innerAmount: 0.28, innerScale: 6.0,
      innerDensity: 0.5, edgeDark: 0.5, specPower: 62, rimWidth: 0.58, opacity: 0.93, wobble: 0.11,
    },
    field: {
      motion: 'packed', count: 40, minRadius: 1.05, maxRadius: 2.1,
    ...
    grade: { ...base.grade, farBlur: 4.0, bloom: 0.24, vignette: 0.12, saturation: 1.08, contrast: 1.07 },
  },
  {
    id: 'v07-peach-nectar',
    name: 'Peach Nectar',
    ...
    glass: {
      ...
      specColor: [1, 0.99, 0.95], refract: 0.044, absorb: 1.24, fresnelStrength: 0.34,
      specStrength: 1.0, innerAmount: 0.3, innerScale: 4.6, innerDensity: 0.4,
      edgeDark: 0.34, specPower: 48, rimWidth: 0.66, opacity: 0.93, wobble: 0.06,
    },
    field: {
      motion: 'macroHero', heroRadius: 2.55, count: 22, minRadius: 1.4, maxRadius: 3.0,
      spreadX: 7.5, spreadY: 5.0, spreadZ: 7.0, driftSpeed: 0.12, rotateSpeed: 0.05,
      farRatio: 0.55, nearRatio: 0.0, seed: 7077,
    },
    camera: { ...base.camera, fov: 34, frameHeight: 10, pushIn: 0.6 },
  ...
  },
  {
    ...
    durationInFrames: 300,
    background: {
      inner: [0.97, 0.98, 1.0], outer: [0.86, 0.89, 0.93],
    ...
    glass: {
      ...
      specColor: [1, 1, 1], refract: 0.051, absorb: 1.04, fresnelStrength: 0.3,
      specStrength: 1.2, innerAmount: 0.14, innerScale: 5.0, innerDensity: 0.2,
      edgeDark: 0.4, specPower: 60, rimWidth: 0.6, opacity: 0.93, wobble: 0.14,
    },
    field: {
      motion: 'float', count: 26, minRadius: 0.6, maxRadius: 1.6,
  ...
  },
  {
    ...
    glass: {
      ...
      specColor: [1, 1, 1], refract: 0.065, absorb: 1.36, fresnelStrength: 0.4,
      dispersion: 0.06, specStrength: 1.35, innerAmount: 0.28, innerScale: 6.0,
      innerDensity: 0.5, edgeDark: 0.5, specPower: 62, rimWidth: 0.58, opacity: 0.93, wobble: 0.11,
    },
    field: {
    ...
    camera: { ...base.camera, fov: 36, frameHeight: 10, pushIn: 0.35 },
    grade: { ...base.grade, farBlur: 4.0, bloom: 0.24, vignette: 0.12, saturation: 1.1, contrast: 1.07 },
  },
  {
    id: 'v10-rose-quartz',
    name: 'Rose Quartz',
    ...
    durationInFrames: 300,
    background: {
      inner: [1.0, 1.0, 1.0], outer: [0.9, 0.9, 0.92],
    ...
    glass: {
      ...
      specColor: [1, 1, 1], refract: 0.051, absorb: 0.96, fresnelStrength: 0.34,
      specStrength: 1.25, innerAmount: 0.2, innerScale: 5.2, innerDensity: 0.3,
      edgeDark: 0.42, specPower: 60, rimWidth: 0.58, opacity: 0.93, wobble: 0.08,
    },
    field: {
      motion: 'float', count: 28, minRadius: 0.5, maxRadius: 1.5,
  ...
  },
  {
    ...
    glass: {
      ...
      specColor: [1, 1, 1], refract: 0.068, absorb: 0.72, fresnelStrength: 0.46,
      dispersion: 0.07, specStrength: 1.5, innerAmount: 0.18, innerDensity: 0.24,
      edgeDark: 0.5, specPower: 70, rimWidth: 0.55, opacity: 0.93, wobble: 0.16,
    },
    field: {
      motion: 'converge', count: 72, minRadius: 0.34, maxRadius: 1.0,
      spreadX: 3.4, spreadY: 2.2, spreadZ: 2.6, driftSpeed: 0.3, rotateSpeed: 0.12,
      farRatio: 0.3, nearRatio: 0.1, seed: 1111,
    },
    camera: { ...base.camera, fov: 40, frameHeight: 10 },
    grade: { ...base.grade, vignette: 0.06, saturation: 1.06, contrast: 1.08, farBlur: 2.6 },
  },
  {
    id: 'v12-marine-swirl',
    name: 'Marine Swirl',
    ...
    glass: {
      ...
      specColor: [1, 1, 1], refract: 0.058, absorb: 0.76, fresnelStrength: 0.44,
      dispersion: 0.06, specStrength: 1.45, innerAmount: 0.2, innerScale: 5.6,
      innerDensity: 0.26, edgeDark: 0.46, specPower: 68, rimWidth: 0.56, opacity: 0.93, wobble: 0.1,
    },
    field: {
      motion: 'swirl', count: 64, minRadius: 0.3, maxRadius: 1.15,
      spreadX: 8.5, spreadY: 5.2, spreadZ: 6.0, driftSpeed: 0.55, rotateSpeed: 0.14,
      farRatio: 0.38, nearRatio: 0.16, seed: 1212,
    },
  ...
  },
  {
    ...
    glass: {
      ...
      fresnelPower: 3.0, fresnelStrength: 0.4, dispersion: 0.11,
      specPower: 75, specStrength: 1.6, innerAmount: 0.34, innerScale: 7.0,
      innerDensity: 0.5, iridescence: 0.3, edgeDark: 0.44, rimWidth: 0.54, opacity: 0.93, wobble: 0.13,
    },
    field: {
      motion: 'packed', count: 30, minRadius: 1.2, maxRadius: 2.3,
    ...
    grade: { ...base.grade, farBlur: 4.4, bloom: 0.34, bloomThreshold: 0.66, chroma: 0.025, vignette: 0.2, saturation: 1.12, contrast: 1.08 },
  },
  {
    ...
    glass: {
      ...
      fresnelStrength: 0.5, specStrength: 1.2, innerAmount: 0.12,
      innerScale: 3.0, innerDensity: 0.16, edgeDark: 0.5, specPower: 64, rimWidth: 0.56, opacity: 0.93, wobble: 0.05,
      shellGap: 0.3,
    },
    field: {
      motion: 'cell', count: 26, minRadius: 0.75, maxRadius: 1.6,
  ...
  },
  {
    ...
    background: {
      ...
      rampColor: [1.0, 0.72, 0.78], rampAmount: 0.18, rampAngle: 2.0, panel: 0.12,
    },
    glass: {
      ...base.glass, tint: [0.98, 0.3, 0.55], rimColor: [1.0, 0.82, 0.88],
      specColor: [1, 1, 1], refract: 0.061, absorb: 1.44, fresnelStrength: 0.4,
      dispersion: 0.07, specStrength: 1.3, innerAmount: 0.26, innerScale: 4.8,
      innerDensity: 0.38, edgeDark: 0.46, specPower: 64, rimWidth: 0.58, opacity: 0.93, wobble: 0.09,
    },
    field: {
      motion: 'swirl', count: 48, minRadius: 0.4, maxRadius: 1.35,
      spreadX: 8.5, spreadY: 5.2, spreadZ: 5.5, driftSpeed: 0.42, rotateSpeed: 0.13,
      farRatio: 0.34, nearRatio: 0.14, seed: 1515,
    },
    camera: { ...base.camera, fov: 38, frameHeight: 10 },
    grade: { ...base.grade, farBlur: 5.0, nearBlur: 6.0, bloom: 0.28, vignette: 0.12, saturation: 1.14, contrast: 1.06 },
  },
];
