...
const BLUE_BANDS: BandSpec[] = [
  ...
  { id: "b1", radius: 0.56, thickness: 30, symmetry: 2, periods: 4, spin: -1, bright: true, tickCount: 4, dashCount: 2, blockCount: 1, depth: "near",
    arcs: [{ start: 5, span: 110 }, { start: 133, span: 37 }] },
  { id: "b2", radius: 0.64, thickness: 12, symmetry: 1, periods: 3, spin: 1, bright: false, tickCount: 3, dashCount: 2, blockCount: 0, depth: "near",
    arcs: [{ start: 22, span: 70 }, { start: 108, span: 52 }, { start: 181, span: 80 }, { start: 286, span: 45 }] },
  { id: "b3", radius: 0.72, thickness: 38, symmetry: 1, periods: 1, spin: -1, bright: true, tickCount: 7, dashCount: 4, blockCount: 2, depth: "near",
  ...
  { id: "b5", radius: 0.86, thickness: 26, symmetry: 1, periods: 1, spin: -1, bright: false, tickCount: 6, dashCount: 3, blockCount: 1, depth: "mid",
    arcs: [{ start: 30, span: 95 }, { start: 152, span: 120 }, { start: 300, span: 45 }] },
  { id: "b6", radius: 0.93, thickness: 16, symmetry: 2, periods: 2, spin: 1, bright: false, tickCount: 3, dashCount: 2, blockCount: 0, depth: "mid",
