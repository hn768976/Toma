...
| `fonts.ts` | Inter (heavy sans) + Source Serif 4 for the montage, Archivo Black for the centre word, gated with `delayRender()`/`continueRender()`. |
...
The montage uses Inter and Source Serif 4. The centre word uses Archivo Black —
