...
export const PRESETS: Preset[] = [
  ...
  {
    id: "Bacteria05VioletMatte",
    title: "05 — Violet matte key",
    reference: "istockphoto-2278455892 (matte pass)",
    durationInFrames: 396, // 13.200s
    seed: 2027,
    camera: { fov: 34, z: [9.1, 8.1], panX: 0.22, panY: 0.14 },
    backdrop: {
      base: "#000000",
      glowColor: "rgba(30,20,74,0.5)",
      glowX: 50,
      glowY: 50,
      glowRadius: 40,
      glow2Color: "rgba(6,5,22,0.85)",
      glow2X: 50,
      glow2Y: 50,
      glow2Radius: 76,
      bokehColor: "#2a2370",
    ...
    grade: { vignette: 0.72, vignetteColor: "rgba(0,0,0,0.92)", grain: 0.05, bloom: 0.3, bloomBlurPx: 24, saturate: 1.1, contrast: 1.14, brightness: 0.95 },
    spheres: noSpheres,
  },
  {
  ...
  },
  {
    ...
    backdrop: {
      base: "#100109",
      glowColor: "rgba(140,16,70,0.8)",
      glowX: 52,
      glowY: 40,
      glowRadius: 58,
      glow2Color: "rgba(36,2,18,0.9)",
      glow2X: 50,
      glow2Y: 96,
      glow2Radius: 66,
      bokehColor: "#8a0c3c",
    ...
    layers: [
      { count: 26, depth: [-8, -4.6], scale: [0.38, 0.63], blurPx: 18, opacity: 0.55, drift: 0.1, spin: 0.1, spreadX: 4.6, spreadY: 2.8, clustering: 0.08 },
      { count: 19, depth: [-4, -1.8], scale: [0.52, 0.81], blurPx: 5, opacity: 0.9, drift: 0.13, spin: 0.13, spreadX: 3.9, spreadY: 2.4, clustering: 0.1 },
      { count: 13, depth: [-1.4, 1.1], scale: [0.68, 1.12], blurPx: 0, opacity: 1, drift: 0.16, spin: 0.16, spreadX: 3.3, spreadY: 2, clustering: 0.12 },
    ],
    grade: { vignette: 0.66, vignetteColor: "rgba(8,0,4,0.92)", grain: 0.05, bloom: 0.38, bloomBlurPx: 28, saturate: 1.26, contrast: 1.12, brightness: 1.0 },
    spheres: noSpheres,
  },
  {
    ...
    layers: [
      { count: 92, depth: [-9.5, -5.4], scale: [0.21, 0.4], blurPx: 9, opacity: 0.6, drift: 0.12, spin: 0.14, spreadX: 6.2, spreadY: 3.7, clustering: 0.05 },
      { count: 46, depth: [-5, -2.4], scale: [0.29, 0.56], blurPx: 3, opacity: 0.85, drift: 0.15, spin: 0.17, spreadX: 5.4, spreadY: 3.2, clustering: 0.06 },
      { count: 16, depth: [-2, 1.4], scale: [0.4, 1.52], blurPx: 0, opacity: 1, drift: 0.19, spin: 0.2, spreadX: 4.6, spreadY: 2.8, clustering: 0.07 },
    ],
    grade: { vignette: 0.62, vignetteColor: "rgba(0,6,12,0.9)", grain: 0.05, bloom: 0.3, bloomBlurPx: 30, saturate: 1.1, contrast: 1.08, brightness: 1.0 },
