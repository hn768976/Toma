...
// The decks are held at a constant distance like the map plates — they
// never go through depthAt() — so they stay a stable horizon for the
// pan to slide along instead of rushing past and through the lens.
//
