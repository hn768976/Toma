...
// render time.
//
// The plates are pinned to the frame, so a plate's own rectangle would
// otherwise sit there as a visible box for the whole shot. The falloff
// is elliptical — both axes — to dissolve that edge into the
// background.
const EDGE_RX = 1.3; // normalised radii of the falloff ellipse
const EDGE_RY = 1.25;
